...
_REF_TEXT = {
    ...
    "rest": dict(
        ...
        note=("THE SIX ROWS ARE INDEPENDENT -- the subtrahend is IDENTICAL for all six, so "
              ...
              "the block-time structure INSIDE the null, gives observed/null **1.622** over 44 "
              "pre-stroke sessions, above null in **44/44**, and 4/4 animals (PS92 1.444, PS93 "
              "1.996, PS94 1.662, PS95 1.500; mean over animals 1.650) -- on the `restdock05` "
    ...
    REST_WEIGHTED: dict(
        ...
        note=("THE SIX ROWS ARE INDEPENDENT, as with `_RESTref_`: one subtrahend for all six, so "
              ...
              "position-neutral -- observed/null **1.622** over 44 pre-stroke sessions, **44/44**, "
