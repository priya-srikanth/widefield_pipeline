...
baseline-drift figure (~52% of signal) is superseded by `uniform_shift_check`'s **3.1%** on
restdock05; and `PREPROCESSING_DECISION.md`'s "nothing re-run yet" line was five weeks stale. It
